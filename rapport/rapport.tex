...
\begin{table}[h]
	...
	\begin{tabular}{|p{6cm}|p{1.5cm}|p{1.5cm}|p{2.5cm}|p{3.5cm}|}
		...
		\multicolumn{5}{|p{14cm}|}{\textbf{Commentaires}} \\ \hline
		\multicolumn{5}{|p{14cm}|}{...} \\ \hline
		\multicolumn{5}{|p{14cm}|}{\textbf{Recommandation}} \\ \hline
		\multicolumn{5}{|p{14cm}|}{...} \\ \hline
...
Le but de cette méthode d'évaluation est de confronter l'interface à des experts avant qu'elle ne soit confronter à des utilisateurs. Cela nous permettra de baliser les potentielles erreurs avant d'impliquer des utilisateurs. 
Le test s'effectuera sur un scénario que l'utilisateur devra réaliser. 

Effectivement, nous essayons via cela d'obtenir des retours critiques qui nous aiderons à améliorer notre outils. 
...
D'ailleurs, nous estimons avoir besoin d'au moins 4 experts minimum, afin de récolter divers avis qui pourront être synthétiser pour en tirer des conclusions.
...
Dans le but de réaliser cette méthode d'évaluation, il sera nécessaire de créer des séquences d'actions qui permettront aux expert d'évaluer l'outil de visualisation.
\begin{figure}[!h]
	\centering
...
Dans le but d'obtenir un retour sur les différentes actions que l'expert va réaliser, en plus de lui fournir la suite de taches optimales, nous lui fournissons une fiche d'évaluation sur laquel il inscrira les retours sur l'outil.
