...
De plus, nous aimerions ajouter un jeu de données concernant le coût monétaire des trajets en avion, afin d'être en accord avec notre mockup. Cependant, nous n'avons pas identifié de jeux de données appropriés qui feraient l'affaire. En conséquence, nous envisageons l'utilisation d'une API capable de récupérer en temps réel les coûts actuels des trajets aériens, assurant ainsi des données constamment mises à jour. 
Nous avons trouver une API qui ferait l'affaire : "Flight Data" 

\href{https://rapidapi.com/Travelpayouts/api/flight-data/}{Flight Data}
Ou via l'URL : \url{https://rapidapi.com/Travelpayouts/api/flight-data/}
